...
# Default data paths (use bundled release structure)
DEFAULT_RESULTS_DIR = REPO_ROOT / 'results' / 'metrics_per_sentence'
DEFAULT_ALIGNMENTS_DIR = REPO_ROOT / 'results' / 'system_alignments'
...
SYSTEMS = {
    'baseline': {
        'baseline_wo_ft_A1': {
            'results_file': 'aer_per_sentence_baseline_wo_ft_A1.jsonl',
            'alignments_file': 'baseline/alignments_baseline_wo_ft_A1.json',
            'gold_file': 'gold_test.json',
            'display_name': 'Baseline A1 (wo_ft)'
        },
        'baseline_ft_A2': {
            'results_file': 'aer_per_sentence_baseline_ft_A2.jsonl',
            'alignments_file': 'baseline/alignments_baseline_ft_A2.json',
            'gold_file': 'gold_test.json',
            'display_name': 'Baseline A2 (ft_wo_dev)'
        }
    },
    'ner': {
        'ner_C1': {
            'results_file': 'aer_per_sentence_ner_C1.jsonl',
            'alignments_file': 'ner_methods/split_C1_alignments.json',
            'gold_file': 'gold_test_ner.json',
            'display_name': 'NER C1 (join_multiword)'
        },
        'ner_C2': {
            'results_file': 'aer_per_sentence_ner_C2.jsonl',
            'alignments_file': 'ner_methods/split_C2_alignments.json',
            'gold_file': 'gold_test_ner.json',
            'display_name': 'NER C2 (transliteration_matching)'
        },
        'ner_C3': {
            'results_file': 'aer_per_sentence_ner_C3.jsonl',
            'alignments_file': 'ner_methods/split_C3_alignments.json',
            'gold_file': 'gold_test_ner.json',
            'display_name': 'NER C3 (entity_placeholder)'
        },
        'ner_C4': {
            'results_file': 'aer_per_sentence_ner_C4.jsonl',
            'alignments_file': 'ner_methods/split_C4_alignments.json',
            'gold_file': 'gold_test_ner.json',
            'display_name': 'NER C4 (entity_tagging)'
        }
    },
    'seg_bert': {
        'seg_bert_D1': {
            'results_file': 'aer_per_sentence_seg_bert_D1.jsonl',
            'alignments_file': 'segmented_bert_an/split_D1_alignments_agg.json',
            'gold_file': 'gold_test.json',
            'display_name': 'Segmented BERT D1'
        },
        'seg_bert_D2': {
            'results_file': 'aer_per_sentence_seg_bert_D2.jsonl',
            'alignments_file': 'segmented_bert_an/split_D2_alignments_agg.json',
            'gold_file': 'gold_test.json',
            'display_name': 'Segmented BERT D2'
        },
        'seg_bert_ATB': {
            'results_file': 'aer_per_sentence_seg_bert_ATB.jsonl',
            'alignments_file': 'segmented_bert_an/split_ATB_alignments_agg.json',
            'gold_file': 'gold_test.json',
            'display_name': 'Segmented BERT ATB'
        },
        'seg_bert_D4': {
            'results_file': 'aer_per_sentence_seg_bert_D4.jsonl',
            'alignments_file': 'segmented_bert_an/split_D4_alignments_agg.json',
            'gold_file': 'gold_test.json',
            'display_name': 'Segmented BERT D4'
        }
    }
}
