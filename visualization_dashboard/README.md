...
Default data is bundled from the release root:
- Per-sentence AER results (JSONL): `../results/metrics_per_sentence/`
- Alignment files (JSON): `../results/system_alignments/`
- Gold standard files: `../data/GOLD/`
